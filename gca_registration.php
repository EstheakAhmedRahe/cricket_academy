...
<head>
  ...
  <form action="gca_insert.php" method="post" data-aos="zoom-in-down">
        <div class="w-75 m-auto">
        <div class="mb-4">    
      <h3 style="display: flex;align-items: center;justify-content: center; color:white;">GCA Student Registration</h3>  
  </div>
  <div class="mb-3">
  ...
  <span class="text-light">Address: </span>
    <input type="text" class="form-control" placeholder="Enter your address" name="address">
            ...
            <div class="mb-3 text-center pt-3 pb-3">
                <button class="btn btn-outline-info mr-2" style="width: 200px;" name="submit" type="submit"> submite </button>
              </div>
