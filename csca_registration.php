  ...
  <body >
   ...
   <div class="container-fluid pb-5">
    <div class="row justify-content-center mt-3">
      ...
      <form action="csca_insert.php" method="post"  data-aos="zoom-in-down">
        <div class="w-75 m-auto">
        <div class="mb-4">    
      <h3 style="display: flex;align-items: center;justify-content: center; color:white;">CSCA Student Registration</h3>  
  </div>
  <div class="mb-3">
